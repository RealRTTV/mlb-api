...
impl<S: sports_players_request_builder::State + sports_players_request_builder::IsComplete> crate::requests::links::StatsAPIRequestUrlBuilderExt for SportsPlayersRequestBuilder<S> {
